  ...
  fetch(finalURL)
    ...
    .then(function (data) {
      ...
      var coordURL =
        ...
        "&lon=" +
        lon +
        "&&appid=51b8740ba38e6f14ed03de9b608c5b7a";
      fetch(coordURL)
        .then(function (response) {
          return response.json();
        })
